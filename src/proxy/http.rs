...
impl HttpResponse {
    ...
    pub async fn send_json_response(
        ...
        writer
            ...
            .await
            .map_err(|e| Error::Communication(format!("Failed to send JSON response: {}", e)))?;
    ...
    pub async fn send_error_response(
        ...
        writer
            .write_all(response.as_bytes())
            .await
            .map_err(|e| Error::Communication(format!("Failed to send error response: {}", e)))?;
    ...
    pub async fn handle_options_request(
        ...
        writer
            .write_all(response.as_bytes())
            .await
            .map_err(|e| Error::Communication(format!("Failed to send CORS response: {}", e)))?;
